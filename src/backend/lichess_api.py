...
class LichessAPI:
    ...
    @staticmethod
    def get_user_games(username: str, max_games: int = 5) -> List[Dict]:
        """
        ...
        try:
            ...
            response = requests.get(url, headers=LichessAPI.HEADERS, params=params)
            ...
            print("Response preview:", response.text[:500] if 'response' in locals() else "")
            return []
